...
"The expected prompt message","A locator","The expected string of the title (Exact matching).Variable declared in the storeXXX commands can be used in the string. For example: \"Hello ${var_usr}\"","A locator","X","X",
"X","A locator","Auto-generated","The locator of the element to be dragged","A locator"," 	The string to be printed in the log console. Variable declared in the storeXXX commands can be used in the string. For example: \"Hello ${var_usr}\"","A locator","A locator","A locator","A locator","A locator","A locator",
"A URL","X","A locator of a multi-select box","The Javascript code to be run. For example: \"var a=10; var b=10; console.log(a+b);\"NOTE THAT: Avoid using alert(), prompt(), and confirm(). These three functions will not take effect while running. Please use console.log() to log messages instead.","A locator of a drop-down menu","\"index=0\" (Select the first frame of index 0)\"relative=parent\" (Select the parent frame)\"relative=top\" (Select the top frame)",
"Auto-generated","A locator","A string to store","A JavaScript expression, variable, statement, or sequence of statements.\
For example: \"x=2; y=3; z = Math.max(x,y);\". The statements will be evaluated to 3 that will be stored in the variable declared in this command's value, say ret.","A locator"," 	The title to store (auto-generated)","A locator","A locator for the form to be submitted","A locator","A locator","The expected string of the title (Exact matching). The next command will still be run even if the text verification fails.Variable declared in the storeXXX commands can be used in the string. For example: \"Hello ${var_usr}\"","A locator"];


var valueTd=["An option locator of the element to be added. For example: \"label=Option1\"","X","X","X",
"X","The expected string of the target element (Exact matching).Variable declared in the storeXXX commands can be used in the string. For example: \"Hello ${var_usr}\"","X","The expected value of the target element (Exact matching).\
...
"x,y position of the mouse event relative to the target element. For example: \"10,10\". The value can left blank to denote a simple click.","X","The string to be set to the content of the target element with attribute contenteditable=\"true\"","x,y position of the mouse event relative to the target element. For example: \"10,10\"",
