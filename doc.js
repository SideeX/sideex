var commandTd=["addSelection","answerOnNextPrompt","assertAlert","assertConfirmation","assertPrompt","assertText","assertTitle","chooseCancelOnNextConfirmation","chooseCancelOnNextPrompt","chooseOkOnNextConfirmation","clickAt","dragAndDropToObject","doubleClickAt","echo","editContent","mouseDownAt","mouseMoveAt","mouseOut","mouseOver","mouseUpAt","open","pause","removeSelection","runScript","select","selectFrame","selectWindow","sendKeys","store","storeText","storeTitle","type","verifyText","verifyTitle"];
...
"X","A locator","The locator of the element to be dragged","A locator","X","A locator","A locator","A locator","A locator","A locator","A locator",
...
"Auto-generated","A locator","A string","A locator","The title auto-generated","A locator","A locator","The expected string of the title (Exact matching). The next command will still be run even if the text verification fails.Variable declared in the storeXXX commands can be used in the string. For example: \"Hello ${var_usr}\""];
...
"X","X","x,y position of the mouse event relative to the target element. For example: \"10,10\". The value can left blank to denote a simple click.","The locator of the element on which the target element is dropped",
